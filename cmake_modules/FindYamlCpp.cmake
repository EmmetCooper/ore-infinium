...
if(WIN32)
    ...
    if (YAMLCPP_LIBRARY AND YAMLCPP_DEBUG_LIBRARY)
        set(YAMLCPP_LIBRARIES optimized ${YAMLCPP_LIBRARY} debug ${YAMLCPP_DEBUG_LIBRARY})
    elseif(YAMLCPP_LIBRARY)
        set(YAMLCPP_LIBRARIES optimized ${YAMLCPP_LIBRARY})
    elseif(YAMLCPP_DEBUG_LIBRARY)
        set(YAMLCPP_LIBRARIES debug ${YAMLCPP_DEBUG_LIBRARY})
    endif()
